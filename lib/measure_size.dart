...
class MeasuredSize extends StatefulWidget {
  ...
  /// [onChange] will return the value ONLY once if it didn't change,
  /// and it will NOT return a value if it's equals to [Size.zero]
...
class _MeasuredSizeState extends State<MeasuredSize> {
  ...
  void postFrameCallback(_) async {
    ...
    await Future.delayed(const Duration(milliseconds: 10)); // wait till the image is drawn
